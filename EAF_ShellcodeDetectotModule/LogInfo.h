...
#define MCEDP_STATUS_POSSIBLE_ROP_CHAIN			MCEDP_ERROR_BASE+17
#define MCEDP_ERROR_INSUFFICIENT_SPACE			MCEDP_ERROR_BASE+18
#define MCEDP_ERROR_NOT_DECODABLE				MCEDP_ERROR_BASE+19
