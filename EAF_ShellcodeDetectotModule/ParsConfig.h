...
typedef struct _MCEDPREGCONFIG
{
	...
	struct {
		...
		BOOL ALLOW_MALWARE_DOWNLOAD;			// IMPLEMENTE
	...
	struct {
		...
		BOOL CALL_VALIDATION;					// IMPLEMENTED
		BOOL FORWARD_EXECUTION;					// IMPLEMENTED
		DWORD FORWARD_EXECUTION_MAX_INS_COUNT;	// IMPLEMENTED
		DWORD FE_FAR;							// TODO: What's this for?
